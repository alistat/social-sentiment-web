...
export default {
  ...
  'POST /topic': function ({state}, urlParams, mutParam, apiParam, broadcast) {
  ...
  'PATCH /topic/:tid': function ({state}, urlParams, mutParam, apiParam, broadcast) {
    let resp = Object.assign({}, state.topics[+urlParams.tid], apiParam);
    broadcast('topics-list', 'mutation-topics', {mut: 'editTopic', data: resp});
    return resp;
  },
  'DELETE /topic/:tid': function ({state}, urlParams, mutParam, apiParam, broadcast) {
    broadcast('topics-list', 'mutation-topics', {mut: 'deleteTopic', data: urlParams.tid});
    return {};
  },
  'SOCKET watch-topics-list': function ({state}, urlParams, mutParam, apiParam, socketServer) {
